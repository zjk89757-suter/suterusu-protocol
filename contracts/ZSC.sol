...
contract ZSC {
    ...
    //function fundPlain(, uint256 bTransfer) public {
    ...
    //function burnPlain(Utils.G1Point memory y, uint256 bTransfer, Utils.G1Point memory u, bytes memory proof) public {
        //bytes32 yHash = keccak256(abi.encode(y));
        //require(registered(yHash), "Account not yet registered.");
        //rollOver(yHash);
